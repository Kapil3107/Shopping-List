...
export class ItemModal extends Component {
    ...
    onSubmit = (e) => {
        ...
        const newItem = {
            name: this.state.name // this is the name that will be updated in the state which will be typed in input
        }
...
export default connect(mapStateToProps, { addItem })(ItemModal); // here if we don't use the fn it will still work.
